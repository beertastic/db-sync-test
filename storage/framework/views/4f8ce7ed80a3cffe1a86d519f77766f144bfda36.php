...
<head>
    ...
    <!-- Page title -->
    <title><?php echo $__env->yieldContent('page_title', 'Superyachts Admin'); ?></title>
    ...
    <div id="navigation">
        ...
        <ul class="nav" id="side-menu">
            <li <?php if(Request::path() == 'admin'): ?> class="active"<?php endif; ?>>
                <a href="<?php echo e(url('admin')); ?>"> <span class="nav-label">Home</span> </a>
            </li>
            <li <?php if(Request::path() == 'admin/yacht'): ?> class="active"<?php endif; ?>>
                <a href=""> <span class="nav-label">Yachts</span> </a>
            </li>
            <li>
                <a href=""> <span class="nav-label">Brokers</span> </a>
            </li <?php if(Request::path() == 'admin/broker'): ?> class="active"<?php endif; ?>>
            <li>
                <a href=""> <span class="nav-label">Builders / Refitters</span> </a>
            </li>
            <li <?php if(Request::path() == 'admin/architech'): ?> class="active"<?php endif; ?>>
                <a href=""> <span class="nav-label">Architects</span> </a>
            </li>
            <li <?php if(Request::path() == 'admin/designer'): ?> class="active"<?php endif; ?>>
                <a href=""> <span class="nav-label">Designers</span> </a>
            </li>
            <li <?php if(Request::path() == 'admin/marina'): ?> class="active"<?php endif; ?>>
                <a href=""> <span class="nav-label">Marinas</span> </a>
            </li>
            <li <?php if(Request::path() == 'admin/multimedia'): ?> class="active"<?php endif; ?>>
                <a href=""> <span class="nav-label">Multimedia</span> </a>
            </li>
            <li>
                <span class="nav-label">------------------------------------------</span>
            </li>
            <li <?php if(Request::path() == 'admin/data'): ?> class="active"<?php endif; ?>>
                <a href="<?php echo e(url('admin/data')); ?>"> <span class="nav-label">Data Admin</span> </a>
            </li>
...
<div id="wrapper">
    ...
    <?php echo $__env->yieldContent('main_content', 'This is the main section area'); ?>
    ...
    <footer class="footer">
        ...
        Company 2008 - <?php echo e(date("Y")); ?>
...
<script>
    ...
    $(function () {
        ...
        <?php echo $__env->yieldContent('custom_jquery', ''); ?>
