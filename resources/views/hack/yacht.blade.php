...
@include('hack.menus.search')
@include('hack.menus.mainbar')    <!-- SY.com ... contact us ...  -->
@include('hack.menus.pagenavi')   <!-- Main Menu -->
